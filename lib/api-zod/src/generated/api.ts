...
export const ListInvoiceGroupsQueryParams = zod.object({
  ...
  "expiring": zod.enum(['soon', 'urgent']).optional().describe('Restrict to actionable groups whose filing deadline is within the named window. \"soon\" matches the dashboard Expiring Soon section (within 10 days, weekend-shifted). \"urgent\" is the narrower red-badge band (within 3 days).'),
...
export const ListInvoiceGroupsResponse = zod.object({
  ...
  "evidenceFiles": zod.object({

}).passthrough().nullish(),
  "evidenceNotes": zod.string().nullish(),
  "evidenceChecklist": zod.object({
...
export const UpdateInvoiceGroupOutcomeBody = zod.object({
  "outcome": zod.string(),
  "closureReason": zod.enum(['denied_by_payor', 'cannot_dispute', 'non_issue']).optional(),
  ...
  "closureRootCauseOther": zod.string().nullish(),
  "closureNarrative": zod.string().nullish(),
  "closureAccountabilityTags": zod.array(zod.enum(['driver', 'dispatcher', 'member', 'it_system', 'our_staff', 'external_payor', 'other'])).nullish(),
  "closureAccountabilityOther": zod.string().nullish(),
  "closureDrivers": zod.array(zod.object({
  "name": zod.string(),
  "id": zod.string().nullish()
...
export const ListClaimsQueryParams = zod.object({
  ...
  "expiring": zod.enum(['soon', 'urgent']).optional().describe('Restrict to actionable claims whose filing deadline is within the named window. \"soon\" matches the dashboard Expiring Soon section (within 10 days, weekend-shifted). \"urgent\" is the narrower red-badge band (within 3 days).'),
...
export const GetDashboardSummaryResponse = zod.object({
  ...
  "urgentCount": zod.number().describe('Number of expiring invoice groups whose deadline lands today or on the next business day (with weekend deadlines shifted back to Friday).'),

...
/*  Difference: the leg ledger compresses into a horizontal chip-strip  */
/*  at the top of the work area; the focus panel claims the full        */
/*  vertical body of the center column.                                 */
/* ------------------------------------------------------------------ */

export default function D2D_FocusFront() {
  ...
  return (
    <div className="cc-scope flex flex-col h-screen overflow-hidden bg-[var(--cc-bg)] text-[var(--cc-fg)]">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* CENTER COLUMN: chip-strip + full-height focus panel  ←—— THE DIFFERENCE */}
        <div className="flex-1 border-r border-[var(--cc-border)] flex flex-col bg-[var(--cc-bg)] overflow-hidden">
          ...
          {/* Ledger as horizontal strip — D2's LegRow verbatim, just laid out horizontally */}
          ...
          {/* Focus panel — claims the full remaining vertical body */}
          <div className="flex-1 overflow-y-auto bg-[var(--cc-bg)] custom-scrollbar">
            <FocusPanel leg={selected} />
          </div>
        </div>

        {/* RIGHT COLUMN: Comms + Files + Notes + Activity (verbatim from D2) */}
...
/* ------------------------------------------------------------------ */
/*  Left sidebar — verbatim from D2 (Primary Action + Summary + Admin)  */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/*  Right sidebar — verbatim from D2 (Comm + Files + Notes + Activity)  */
/* ------------------------------------------------------------------ */

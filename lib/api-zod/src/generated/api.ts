...
export const GetInvoiceGroupAttestationHistoryQueryParams = zod.object({
  range: zod
    .enum(["7d", "30d", "all"])
    .default(getInvoiceGroupAttestationHistoryQueryRangeDefault)
    .describe(
...
export const GetInvoiceGroupAttestationHistoryResponse = zod
  .object({
    groups: zod.array(
      zod.object({
        group: zod.object({
...
export const GroupSopAdvanceBody = zod
  .object({
    nodeId: zod
      .string()
      .describe("Decision-tree node id (matches `claims.sop_node_id`)."),
    answer: zod.string().describe("One of the node's option labels."),
    terminalSopOutcome: zod
      .enum([
        "portal_dispute",
        "dispute",
        "hold",
...
export const GroupSopAdvanceResponse = zod
  .object({
    succeeded: zod
      .array(
        zod.object({
    ...
    code: zod
      ...
      .optional()
      .describe("Present only on a 409 response."),
    reason: zod
      .string()
      .optional()
      .describe(

...
- **`<FacetDateRange>`** — paired date inputs with optional preset chips (Last 7 days, This month, etc.). Currently used without presets; the preset slot is reserved for future categories that benefit from fast common ranges.

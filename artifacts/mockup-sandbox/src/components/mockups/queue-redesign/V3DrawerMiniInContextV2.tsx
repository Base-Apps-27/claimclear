...
export default function V3DrawerMiniInContextV2({
...
function LegContextHeaderCard() {
  return (
    ...
    >
      ...
      {/* Top row — invoice circle (top-left, sole drilldown) + conf number lead + close */}
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", minWidth: 0, flex: 1 }}>
          ...
          <span className="cc-meta" style={{ fontSize: "0.6875rem", marginTop: 2 }}>
            Leg 1 of 3 · INV-2026-0487
          </span>
        </div>
        <button
          aria-label="Close"

  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-[1.2vh]" style={{ flex: 1 }}>
        ...
        <Callout number="4" title="Assign and continue" body="The group's status flips from Needs Review → Needs Evidence and shows up in Action Required. Walking away (Non-Issue / Cannot Dispute / Accepted Loss) happens later as a closure exit." />
      </div>
    </SlideShell>
  );
}

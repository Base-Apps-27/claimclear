...
export type BulkGenerateAndReviewResultSkippedItem = {
  id: number;
  refNumber?: string | null;
  reason: string;
};

export interface BulkGenerateAndReviewResult {
  generated: number;
  generatedItems?: BulkGenerateAndReviewResultGeneratedItemsItem[];
  skipped?: BulkGenerateAndReviewResultSkippedItem[];
  success?: boolean;
}
